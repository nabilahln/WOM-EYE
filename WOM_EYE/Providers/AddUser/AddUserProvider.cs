    ...
    public class AddUserProvider : IAddUserProvider
    {
        ...
        public List<AddUserModel> getAllAddUser()
		{
			...
			while (dataAddUser.Read())
			{
				...
				AddUser.USER_POSITION = dataAddUser[4].ToString();
				//AddUser.USER_PASS = dataAddUser[6].ToString();
				AddUser.DIVISION = dataAddUser[5].ToString();
				AddUser.PHONE = dataAddUser[6].ToString();
				AddUser.GENDER = dataAddUser[7].ToString();
				AddUser.CODE_UNIQUE = dataAddUser[8].ToString();
		...
		public AddUserModel getCodeById(int id)
		{
			string sp = "spWOMEYE_GetCodeById";
