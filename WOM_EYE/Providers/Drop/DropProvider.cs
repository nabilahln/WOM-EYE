...
namespace WOM_EYE.Providers.Drop
{
	public class DropProvider : IDropProvider
	{
        ...
        public List<DropModel> getAllDrop(string userId)
        {
			string spName = "spWOMEYE_AllDropNew";
			var data = _dbConnection.ExecuteReader(spName, new { @userId = userId}, commandType: CommandType.StoredProcedure, commandTimeout: 30);
