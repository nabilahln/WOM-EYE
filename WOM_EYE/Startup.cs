...
namespace WOM_EYE
{
	public class Startup
	{
		...
		public void ConfigureServices(IServiceCollection services)
		{
			...
			services.AddScoped<ChangePasswordDTO, ChangePasswordDTO>();
			services.AddScoped<ForgetPasswordModel, ForgetPasswordModel>();
			services.AddScoped<MenuModel, MenuModel>();
			...
			services.AddScoped<List<ForgetPasswordModel>, List<ForgetPasswordModel>>();
			services.AddScoped<List<MenuModel>, List<MenuModel>>();
			...
			services.AddScoped<List<SelectListValidasi>, List<SelectListValidasi>>();
			services.AddScoped<List<SelectListPositionPass>, List<SelectListPositionPass>>();
			services.AddScoped<List<SelectListTahap>, List<SelectListTahap>>();
